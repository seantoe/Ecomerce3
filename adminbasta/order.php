...
if(isset($_POST['remove_order'])) {
    ...
    // Execute the queries
    if(mysqli_query($connection, $deleteOrderQuery) && mysqli_query($connection, $deleteOrderItemsQuery)) {
...
<body>
    <!-- Modal for the Proof of Payment -->
...
<div class="modal fade" id="editStatusModal" tabindex="-1" aria-labelledby="editStatusModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">                
                ...
                <form id="editStatusForm" action="order_editstatus.php" method="POST">
                        <input type="hidden" name="order_id" id="orderID">
                        <div class="mb-3">
                            <label for="newOrderStatus" class="form-label">New Order Status</label>
                            <select class="form-select" id="newOrderStatus"  class="form-control" name="order_status" required>
    ...
    <main>
        ...
        <tbody>
            ...
            $query = "SELECT * FROM users WHERE access_level IN (3,4)";
            ...
            <tr>
                ...
                <td>
                    <center>
                        <?php if ($row['appointed_to'] === 'No one appointed'): ?>
                            <span style="color: red; font-weight: bold;">
                                &#9888;
                        <?php endif; ?>
                        <?php echo $row['appointed_to']; ?>
                        <?php if ($row['appointed_to'] === 'No one appointed'): ?>
                            </span>
                        <?php endif; ?>
                    </center>
                ...
                // Display the image
                echo '<img src="' .$imageURL. '" alt="Proof of Payment" style="max-width: 100%; max-height: 100%;" class="proof-of-payment-image" data-image-url="' .$imageURL. '">';
                ?>
                </td>
                <td>
                    ...
                    <form action="" method="POST" class="remove-order-form">
                        <input type="hidden" name="remove_order" value="<?php echo $row['order_id']; ?>">
...
<script>
    ...
    <script>
        $('#editStatusModal').on('show.bs.modal', function (event) {
            ...
            setOrderID(orderID); // Call the function to set the order ID in the form
        });
    </script>
