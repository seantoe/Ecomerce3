        ...
        <div class="card" style="border-radius: 15px;">
          <div class="card-body p-4">
            <div class="d-flex text-black justify-content-center">
                <h5 class="mb-1">VALID ID: </h5>
                <?php
                    // Fetch the image path from the database
                    $imagePath = $row['valid_id'];

                    // Construct the complete URL to the image
                    $imageURL = 'http://localhost/Ecomerce2/images/' . $imagePath;

                    // Display the image
                    echo '<img src="' . $imageURL . '" alt="Valid ID" alt="Generic placeholder image" class="img-fluid"
                  style="width: 180px; border-radius: 10px;">';
                ?>
            </div>
          </div>
            ...
            <?php } ?>
                ...
                <hr class="border-3 border-dark mx-auto opacity-100" style="width:80px">
                 ...
                 <table id="example" class="table table-striped" style="width:100%">
                    <thead>
                        <tr>
                            <th>Orders: <?php echo $totalOrders; ?></th>
                        </tr>
                    </thead>
                </table>
                ...
                <hr class="border-3 border-dark mx-auto opacity-100" style="width:80px">
                 ...
                 <table id="example" class="table table-striped" style="width:100%">
                    <thead>
                        <tr>
                            <th>Payments: <?php echo $totalPaid; ?></th>
                        </tr>
                    </thead>
                </table>
