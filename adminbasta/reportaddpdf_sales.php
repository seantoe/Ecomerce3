...
if (isset($_POST['user_id'])) {
    ...
    $pdf->Cell(0, 10, $userName . ' Team Report', 0, 1, 'C');
    ...
    $queryClient = "SELECT address FROM orders WHERE id_appoint = $userId GROUP BY address";
    ...
    $queryProduct = "SELECT product_name, SUM(product_quantity) AS total_quantity FROM order_items WHERE id_appoint = $userId GROUP BY product_name";
    ...
    $queryTotalOrderedQuantity = "SELECT SUM(product_quantity) AS total_ordered_quantity FROM order_items WHERE id_appoint = $userId";
    ...
    $queryTotalPrice = "SELECT SUM(order_cost) AS total_price_sold FROM orders WHERE id_appoint = $userId";
    ...
    $queryTotalCollected = "SELECT SUM(order_cost) AS total_collected FROM orders WHERE id_appoint = $userId AND order_status ='Paid'";
