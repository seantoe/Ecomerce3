...
if(isset($_POST['submit'])){
    ...
    $access_level = 1; // Set access level to 1 for Admin
    $contact = $_POST['contact'];
    $position = 'Admin'; // Set position to 'Admin'
...
<body>
    <main>
        ...
        <div id="main-wrapper" class="py-5 px-3">
            <h1 class="text-center"><b>Admin User</b></h1>
                        ...
                        <div class="card card-registration card-registration-2" style="border-radius: 15px;">
                          <div class="card-body p-0">
                            <div class="row g-0">
                              <div class="col-lg-6">
                                <div class="p-5">
                <form action="user_addadmin.php" method="POST" enctype="multipart/form-data">
