...
if (isset($_POST['updateForm'])) {
        ...
        if(isset($_FILES['pfp']) && $_FILES['pfp']['error'] === UPLOAD_ERR_OK) {
            ...
            if(move_uploaded_file($_FILES['pfp']['tmp_name'], $pfp)) {
                ...
                $updateQuery = "UPDATE users SET email='$email', firstname='$fname', lastname='$lname', contact='$contact', pfp='$pfp' WHERE id='$id' ";
            ...
            $updateQuery = "UPDATE users SET email='$email', firstname='$fname', lastname='$lname', contact='$contact' WHERE id='$id' ";
            mysqli_query($connection, $updateQuery);
        }
            ...
            <div id="navBarMenu-container">
                ...
                <div class="ct-top-nav-right">
                    ...
                    <div class="info">
                        ...
                        <small class="text-muted"><?php echo $rows['position']; ?></small>
                    </div>
