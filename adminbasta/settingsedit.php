...
$selectQuery = "SELECT * FROM settings WHERE id=?";
...
if (isset($_POST['updateForm'])) {
    ...
    $updateQuery = "UPDATE settings SET title=?, description=?, logo=?, image1=?, image2=?, contact1=?, contact2=? WHERE id=?";
    $updateStmt = mysqli_prepare($connection, $updateQuery);
    mysqli_stmt_bind_param($updateStmt, 'sssssssi', $title,$description,$logo,$image1,$image2,$contact1,$contact2, $id);
        ...
        <div id="main-wrapper" class="py-5 px-3">
            <div class="container-fluid-md">
                ...
                <div class="form-outline">
                      <input type="text" name="id" value="<?php echo $row['id']; ?>" readonly id="form3Examplev4" class="form-control form-control-m" />
                  ...
                  <div class="mb-4 pb-2">
                    <div class="form-outline">
                      <input type="text" name="title" value="<?php echo $row['title']; ?>" id="form3Examplev4" class="form-control form-control-m" />
                      <label class="form-label" for="form3Examplev4">Title</label>
                    </div>
                  </div>

                  <div class="mb-4 pb-2">
                    <div class="form-outline">
                      <input type="text" name="description" value="<?php echo $row['description']; ?>" id="form3Examplev4" class="form-control form-control-sm" />
                  ...
                  <div class="mb-4 pb-2">
                    <div class="form-outline">
                      <input type="file" name="logo" accept="image/*" id="logoInput" class="form-control form-control-m" onchange="previewImage(this, 'logoPreview')"  />
                      ...
                      <div class="profile-photo">
                       <?php
                        ...
                        // Display the image
                        echo '<img id="logoPreview" src="' . $imageURL . '" alt="Logo Preview" style="max-width: 150px; max-height: 300px; margin-top: 10px;">';
                        ?>
                        </div>
                    </div>
                  </div>
              ...
              <div class="col-lg-6">
                <div class="p-5">
                    ...
                    <div class="mb-4 pb-2">
                    <div class="form-outline">
                      <input type="file" name="image1" accept="image/*" id="image1Input" class="form-control form-control-m" onchange="previewImage(this, 'image1Preview')" />
                      <label class="form-label" for="form3Examplev4">Image</label>
                      <div class="profile-photo">
                       <?php
                        // Fetch the image path from the database
                  ...
                  <div class="mb-4 pb-2">
                    <div class="form-outline">
                      <input type="text" name="contact1" value="<?php echo $row['contact1']; ?>" id="form3Examplev4" class="form-control form-control-sm" />
                      <label class="form-label" for="form3Examplev4">Contact 1</label>
                    </div>
                  </div>

                  <div class="mb-4 pb-2">
                    <div class="form-outline">
                      <input type="text" name="contact2" value="<?php echo $row['contact2']; ?>" id="form3Examplev4" class="form-control form-control-sm" />
                      <label class="form-label" for="form3Examplev4">Contact 2</label>
                    </div>
                  </div>
