...
if(isset($_POST['submit'])){
    ...
    $access_level = 3; // Set access level to 3 for Team Leader
    $contact = $_POST['contact'];
    $position = 'Team Leader'; // Set position to 'Team Leader'
    ...
    mysqli_stmt_bind_param($stmt, "ssssisss", $firstname, $lastname, $email, $hashed_password, $access_level, $address, $contact, $position);
    ...
    // Update the id_team field with the retrieved ID
    $update_query = "UPDATE users SET id_team = ? WHERE id = ?";
    $stmt_update = mysqli_prepare($connection, $update_query);
    mysqli_stmt_bind_param($stmt_update, "ii", $new_user_id, $new_user_id);
...
<body>
    <main>
        ...
        <div id="main-wrapper" class="py-5 px-3">
            <h1 class="text-center"><b>Team Leader User</b></h1>
                        ...
                        <div class="card card-registration card-registration-2" style="border-radius: 15px;">
                          <div class="card-body p-0">
                            <div class="row g-0">
                              <div class="col-lg-6">
                                <div class="p-5">
                <form action="user_addteam.php" method="POST" enctype="multipart/form-data">
