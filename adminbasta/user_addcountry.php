...
if(isset($_POST['submit'])){
    ...
    $insert_query = "INSERT INTO users (firstname, lastname, email, password, access_level, contact, position) VALUES (?, ?, ?, ?, ?, ?, ?)";
    ...
    $access_level = 2; // Set access level to 2 for Country Manager
    $contact = $_POST['contact'];
    $position = 'Country Manager'; // Set position to 'Country Manager'
    ...
    mysqli_stmt_bind_param($stmt, "ssssiss", $firstname, $lastname, $email, md5($password), $access_level, $contact, $position);
...
<body>
    <main>
        ...
        <div id="main-wrapper" class="py-5 px-3">
            <h1 class="text-center"><b>Country Manager User</b></h1>
                        ...
                        <div class="card card-registration card-registration-2" style="border-radius: 15px;">
                          <div class="card-body p-0">
                            <div class="row g-0">
                              <div class="col-lg-6">
                                <div class="p-5">
                <form action="user_addcountry.php" method="POST" enctype="multipart/form-data">
