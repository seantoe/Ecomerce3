...
$nav2 = mysqli_query($connection, $query);
            ...
            <ul class="nav-menu">
                ...
                <li class="nav-item">
                    ...
                    <a href="order.php" class="nav-link notification-link">
                        ...
                        <!-- Display the badge only if there are appointments -->
                        <span id="notificationCount" class="badge bg-danger"><?php echo $numAppointments; ?></span>
                    </a>
                </li>
                <!-- Product widget -->
                <li class="nav-item">
