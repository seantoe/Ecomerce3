...
$query2 = "SELECT product_name, SUM(product_quantity) AS total_quantity FROM order_items WHERE id_appoint = $id GROUP BY product_name";
$quantity = mysqli_query($connection, $query2);

// Function to calculate total quantity with unique product names
function calculateTotalQuantity($connection, $id) {
    $totalQuantity = 0;

    $query = "SELECT SUM(product_quantity) AS total_quantity FROM order_items WHERE id_appoint = $id";
...
$query4 = "SELECT address, COUNT(DISTINCT address) AS total_clients FROM orders WHERE id_appoint = $id GROUP BY address";
...
function calculateTotalClient($connection, $id) {
    ...
    $query = "SELECT COUNT(DISTINCT address) AS total_clients FROM orders WHERE id_appoint = $id";
...
$sql = "SELECT 
            (SELECT SUM(order_cost) FROM orders WHERE id_appoint = $id) AS total_price_sold,
            (SELECT SUM(order_cost) FROM orders WHERE order_status = 'Paid' AND id_appoint = $id) AS total_amount_collected,
            (SELECT SUM(order_cost) FROM orders WHERE order_status != 'Paid' AND id_appoint = $id) AS total_for_collection";
