...
<!-- header -->
    <?php while($rows = mysqli_fetch_array($query2)){ ?>
            <div class="header">
                <div class="container">
                     <div class="navbar"  style="padding: 5px 20px;">
                        <div class="logo">
                        <?php
                    ...
                    <a href="client/cart.php"><span class="material-symbols-outlined" style="color: black;    
    margin-left: 20px;">
                        shopping_cart
                        </span></a>
                    </div>    
...
<!----- featured products -----> 
                ...
                <?php
                    ...
                    <a href="<?php echo "client/singleproduct.php?product_id=". $row['product_id']; ?>"><button>View Product</button></a>
                    </div> 
<?php } ?>
            </div>
        </div>
...
function menutoggle(){
    if(MenuItems.stlye.maxHeight == "0px")
    {
