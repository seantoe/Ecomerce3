...
$sql_display_all = "SELECT * FROM users WHERE access_level IN (4,5) AND id_team = $id";
...
$query3 = mysqli_query($connection, $sql_display_all);
...
<!-- Main Content - Sample Table -->
        ...
        <a class="btn btn-success" href="useradd.php" role="button"><span class="material-symbols-outlined">
                    person_add
                    </span>Add Sales Agent</a>
    ...
    <table id="example" class="table table-striped" style="width:100%">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a class="btn btn-outline-primary" href="userview.php?id=<?php echo $rows['id']; ?>" role="button"><span class="material-symbols-outlined">
                    view_timeline
                    </span>View</a>

                    <a class="btn btn-outline-warning" href="useredit.php?id=<?php echo $rows['id']; ?>" role="button"><span class="material-symbols-outlined">
                    edit
                    </span>Edit</a>

                    <a class="btn btn-outline-danger" href="userdelete.php?id=<?php echo $rows['id']; ?>" role="button"><span class="material-symbols-outlined">
                    view_timeline
                    </span>Delete</a>
